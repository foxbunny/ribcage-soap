...
define(function(require) {
  ...
  return {
    ...
    convertResponse: function(json, options) {
      return this["convert" + options.crudMethod + "Response"](json, options);
    },
